...
CDemoMfcAppDlg::CDemoMfcAppDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_DEMOMFCAPP_DIALOG, pParent)
{
...
BEGIN_MESSAGE_MAP(CDemoMfcAppDlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
...
void CDemoMfcAppDlg::OnBnClickedButton1()
{
	...
	deviceHandle = CreateFile(L"\\\\.\\SasDemoDev", GENERIC_ALL, 0, 0,
		OPEN_EXISTING, FILE_ATTRIBUTE_SYSTEM, 0);
	if (deviceHandle == INVALID_HANDLE_VALUE)
	{
		MessageBox(L"not a valid value", 0, 0);
		return;
	}
	
	// Do your stuff
	MessageBox(L"Driver open success", 0, 0);
	
}


void CDemoMfcAppDlg::OnBnClickedButton2()
{
	// TODO: Add your control notification handler code here
	if (deviceHandle != INVALID_HANDLE_VALUE)
	{
